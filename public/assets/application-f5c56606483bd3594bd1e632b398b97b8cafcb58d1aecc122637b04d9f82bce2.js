...
var append_guest_list = (form, data) => {
  $(form).append(`<tr><td>${data.full_name}</td><td>${data.side}</td><td>${data.relationship}</td><td>${data.plusone}</td><td>${edit_link(data.event_id, data.guest_id)} / ${delete_link(data.event_id, data.guest_id)}</td></tr>`)
}
